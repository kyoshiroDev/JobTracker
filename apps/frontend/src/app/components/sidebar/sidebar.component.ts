...
@Component({
  ...
  host: {
    class:
      'max-w-60 flex flex-col gap-4 border-r border-solid h-screen bg-background p-4',
  },
  template: `
    <div class="max-w-60">
      ...
      <nav class="flex flex-col justify-center gap-3 mt-8 px-3">
        @for (menu of sidebar(); track menu.id) {
          <a
            class="flex max-w-43 h-8 items-center gap-4 py-1 pl-4 hover:text-primary-foreground
