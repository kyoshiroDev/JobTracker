    ...
    <form class="px-6 pb-6 pt-4" [formGroup]="formRegister" (ngSubmit)="onSubmit()">
      ...
      <div class="mb-5">
        ...
        <span class="pl-3 flex items-center">
          ...
          <input id="username" name="username" autocomplete="username"
                 formControlName="username" type="text" placeholder="Jean Dupont"
      ...
      <div class="relative mb-5">
        <div
          ...
          <input id="email" name="email" autocomplete="email" formControlName="email" type="email"
      ...
      <div class="relative">
        <div
          ...
          <input id="password" name="password" autocomplete="new-password"
                 [type]="typePasswordInput()" formControlName="password" placeholder="Mot de passe"
                 class="flex-1 h-9 border-0 outline-none pl-2 placeholder:opacity-70 pt-0.5" />
          <button type="button" (click)="typePasswordChanges.emit('text')"
                  class="pr-3 inline-flex items-center cursor-pointer" aria-label="Afficher/Masquer le mot de passe">
      ...
      <div class="relative">
        <div
          ...
          <input id="confirm-password" name="confirm-password" autocomplete="new-password"
                 [type]="typeConfirmPasswordInput()" formControlName="confirmPassword"
                 placeholder="Confirmer vôtre mot de passe"
                 class="flex-1 h-9 border-0 outline-none pl-2 placeholder:opacity-70 pt-0.5" />
          <button type="button" (click)="typeConfirmPasswordChanges.emit('text')"
