...
import { CompanyForm } from './candidatureForm';
...
@Component({
  ...
  >
    <legend class="text-center font-semibold text-xl md:text-2xl px-2 text-JobTracker-blue">Entreprise</legend>
    <!-- Name -->
    <div class="flex w-full flex-col justify-center items-start gap-2 flex-nowrap">
      ...
      <input id="name" type="text" formControlName="name" placeholder="Google" class="form-input w-full" />
    </div>
    <!-- Ville -->
    <div class="flex w-full flex-col justify-center items-start gap-2 flex-nowrap">
    ...
    <!-- Phone -->
    <div class="flex w-full flex-col justify-center items-start gap-2 flex-nowrap">
      <label for="phone">Téléphone<span class="text-xs text-red-700">*</span></label>
      <input id="phone" type="number" formControlName="phone" placeholder="01.60.68.98.74" class="form-input w-full" />
    </div>
    <!-- Email -->
    <div class="flex w-full flex-col justify-center items-start gap-2 flex-nowrap">
      <label for="email">Email<span class="text-xs text-red-700">*</span></label>
      <input
        id="entreprise"
        type="email"
