...
@Component({
  selector: 'fdw-input-candidatures-form-search',
  ...
  >
    ...
    <div class="px-2 text-JobTracker-blue">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 font-semibold" viewBox="0 0 256 256">
        <path
          fill="currentColor"
          stroke="currentColor"
          stroke-width="10"
...
export class InputCandidatureFormSearchComponent {
  protected readonly fb = inject(FormBuilder);
  protected readonly serviceAnnonce = inject(CandidaturesService);
